...
export function WebinarRegisterPanel({
  ...
  return (
    <>
      ...
      <WebinarRegisterModal open={open} onClose={closeModal} title="Reserve your seat">
        {confirmedTier === "free" ? (
          <div className="webinar-register-confirm">
            ...
            <button type="button" className="button-secondary pressable mt-2" onClick={closeModal}>
              Done
            </button>
          </div>
        ) : confirmedTier === "paid_overflow" ? (
          <div className="webinar-register-confirm">
